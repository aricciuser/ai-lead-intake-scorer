...
import type { Provider, ScoreResponse } from "@/lib/scoringPrompt";

const PRIORITY_STYLES: Record<ScoreResponse["priority"], string> = {
      ...
      <div className="flex items-center justify-between gap-4 p-6 rounded-lg border bg-white">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Scored by {PROVIDER_LABELS[result.provider]}
          </p>
        </div>
        <span
